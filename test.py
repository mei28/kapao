...
#VIDEO_NAME = 'y2mate.com - Jisoo Yu  David Hart  September by Earth Wind  Fire_720p.mp4'
#URL = 'https://www.youtube.com/watch?v=aRNlVNuqDvc'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', type=str, default='sample.mp4', help='video_name')
